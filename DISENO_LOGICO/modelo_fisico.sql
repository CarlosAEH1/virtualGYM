...
--
-- Date Created : Wednesday, May 11, 2022 23:59:21
...
CREATE TABLE EMPLEADO(
    ...
    CONSTRAINT RefPUESTO221 FOREIGN KEY (PUESTO_ID)
...
CREATE TABLE ADMINISTRADOR(
    ...
    CONSTRAINT RefEMPLEADO261 FOREIGN KEY (EMPLEADO_ID)
...
CREATE TABLE CREDENCIAL(
    ...
    CONSTRAINT RefCLIENTE331 FOREIGN KEY (CLIENTE_ID)
...
CREATE TABLE GIMNASIO(
    ...
    CONSTRAINT RefEMPLEADO491 FOREIGN KEY (GERENTE_ID)
    REFERENCES EMPLEADO(EMPLEADO_ID)
)
;
...
CREATE TABLE SALA(
    ...
    CONSTRAINT RefGIMNASIO201 FOREIGN KEY (GIMNASIO_ID)
    REFERENCES GIMNASIO(GIMNASIO_ID),
    CONSTRAINT RefADMINISTRADOR231 FOREIGN KEY (EMP_ADMIN_ID)
...
CREATE TABLE DISPOSITIVO(
    ...
    CONSTRAINT RefSALA291 FOREIGN KEY (SALA_ID)
    REFERENCES SALA(SALA_ID),
    CONSTRAINT RefTIPO_DISPOSITIVO321 FOREIGN KEY (TIPO_DISPOSITIVO_ID)
    REFERENCES TIPO_DISPOSITIVO(TIPO_DISPOSITIVO_ID),
    CONSTRAINT RefSTATUS521 FOREIGN KEY (STATUS_ID)
...
CREATE TABLE HUELLA(
    ...
    CONSTRAINT RefEMPLEADO501 FOREIGN KEY (EMPLEADO_ID)
    REFERENCES EMPLEADO(EMPLEADO_ID)
)
;
...
CREATE TABLE INSTRUCTOR(
    ...
    CONSTRAINT RefEMPLEADO271 FOREIGN KEY (EMPLEADO_ID)
    REFERENCES EMPLEADO(EMPLEADO_ID),
    CONSTRAINT RefINSTRUCTOR401 FOREIGN KEY (SUPLENTE)
...
CREATE TABLE INSTRUCTOR_WEB(
    ...
    CONSTRAINT RefINSTRUCTOR181 FOREIGN KEY (EMPLEADO_ID)
    REFERENCES INSTRUCTOR(EMPLEADO_ID)
)
;
...
CREATE TABLE MULTIMEDIA(
    ...
    CONSTRAINT RefGIMNASIO141 FOREIGN KEY (GIMNASIO_ID)
    REFERENCES GIMNASIO(GIMNASIO_ID)
)
;
...
CREATE TABLE REPORTE(
    ...
    CONSTRAINT RefCLIENTE381 FOREIGN KEY (CLIENTE_ID)
    REFERENCES CLIENTE(CLIENTE_ID)
)
;
...
CREATE TABLE SALA_DISCIPLINA(
    ...
    CONSTRAINT RefSALA471 FOREIGN KEY (SALA_ID)
    REFERENCES SALA(SALA_ID),
    CONSTRAINT RefDISCIPLINA481 FOREIGN KEY (DISCIPLINA_ID)
...
CREATE TABLE SENSOR(
    ...
    CONSTRAINT RefCLIENTE371 FOREIGN KEY (CLIENTE_ID)
    REFERENCES CLIENTE(CLIENTE_ID)
)
;
...
CREATE TABLE SESION(
    ...
    CONSTRAINT RefINSTRUCTOR341 FOREIGN KEY (EMP_INST_ID)
    REFERENCES INSTRUCTOR(EMPLEADO_ID),
    CONSTRAINT RefCLIENTE351 FOREIGN KEY (CLIENTE_ID)
    REFERENCES CLIENTE(CLIENTE_ID),
    CONSTRAINT RefSALA511 FOREIGN KEY (SALA_ID)
    REFERENCES SALA(SALA_ID)
)
;
...
CREATE TABLE SESION_BITACORA(
    ...
    CONSTRAINT RefSESION361 FOREIGN KEY (SESION_ID)
...
CREATE TABLE SESION_DISPOSITIVO(
    ...
    CONSTRAINT RefSESION421 FOREIGN KEY (SESION_ID)
    REFERENCES SESION(SESION_ID),
    CONSTRAINT RefDISPOSITIVO431 FOREIGN KEY (DISPOSITIVO_ID)
...
CREATE TABLE STATUS_DISPOSITIVO(
    ...
    CONSTRAINT RefSTATUS301 FOREIGN KEY (STATUS_ID)
    REFERENCES STATUS(STATUS_ID),
    CONSTRAINT RefDISPOSITIVO311 FOREIGN KEY (DISPOSITIVO_ID)
    REFERENCES DISPOSITIVO(DISPOSITIVO_ID)
)
;
